...
import static java.time.DayOfWeek.*; // considered ok for static imports
...
class DerivedDateTimeTest {
    ...
    public static void testPopularBirthdays() {
        ...
        LocalDate valentinesDay = LocalDate.of(2023, 2, 14);
        LocalDate birth = valentinesDay.plusWeeks(38);
        System.out.println(birth);

        // what is the average birthday of someone conceived on New Year's Eve (after midnight)?
        LocalDate newYearEve = LocalDate.of(2023, 1, 1);
        LocalDate deliveryDate = newYearEve.plusWeeks(38);
    ...
    public static void testEarlyRetirement() {
        LocalDate bday = LocalDate.of(1985, 5, 20);
    ...
    public static void testLaborDay() {
        LocalDate sept1 = LocalDate.of(1985, 9, 1);
    ...
    public static void testAnniversary() {
        ...
        LocalDate dateOfParty = anniversary.with(nextOrSame(SATURDAY));
        System.out.println(anniversary);
        System.out.println(dateOfParty);
        System.out.println(dateOfParty.getDayOfWeek());
    }
}