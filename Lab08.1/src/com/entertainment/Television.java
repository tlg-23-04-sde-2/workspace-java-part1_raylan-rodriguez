...
public class Television {
    ...
    private final Tuner tuner = new Tuner(); //instantiated internally, not exposed ( via get/st)
...
//                               " and " + MAX_VOLUME);
    ...
    public String toString() {
        ...
        return String.format("Television: brand = %s, volume = %s, display =%s, Current Channel = %s",
